...
module ApplicationHelper
  ...
  def project_tree_options_for_select(projects, options = {})
    ...
    project_tree(projects) do |project, level|
      ...
      if level == 0 #Añadido estilo si se trata del primer nivel TODO:Como mejora se podría utilizar alguna propiedad para poner estilo en función del tipo de proyecto
	      tag_options[:id] = 'root-project-option'
      end
