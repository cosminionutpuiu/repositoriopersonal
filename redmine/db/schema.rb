...
ActiveRecord::Schema.define(version: 20170419144536) do
  ...
  add_index "favorite_projects", ["project_id", "user_id"], name: "index_favorite_projects_on_project_id_and_user_id", using: :btree

  create_table "git_caches", force: :cascade do |t|
    t.text     "command",         limit: 65535
    t.binary   "command_output",  limit: 4294967295
    t.string   "repo_identifier", limit: 255
  ...
  add_index "github_comments", ["github_id", "journal_id"], name: "index_github_comments_on_github_id_and_journal_id", unique: true, using: :btree
  ...
  add_index "github_issues", ["github_id", "issue_id"], name: "index_github_issues_on_github_id_and_issue_id", unique: true, using: :btree

  create_table "gitolite_public_keys", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "key_type",           limit: 4,     default: 0
  end

  add_index "gitolite_public_keys", ["fingerprint"], name: "index_gitolite_public_keys_on_fingerprint", unique: true, using: :btree
  add_index "gitolite_public_keys", ["identifier"], name: "index_gitolite_public_keys_on_identifier", using: :btree
  add_index "gitolite_public_keys", ["title", "user_id"], name: "index_gitolite_public_keys_on_title_and_user_id", unique: true, using: :btree
  add_index "gitolite_public_keys", ["user_id"], name: "index_gitolite_public_keys_on_user_id", using: :btree
  ...
  create_table "hgp_cmis_file_locks", force: :cascade do |t|
    t.integer  "hgp_cmis_file_id", limit: 4,                 null: false
  ...
  create_table "hgp_cmis_file_revision_accesses", force: :cascade do |t|
    t.integer  "hgp_cmis_file_revision_id", limit: 4,             null: false
  ...
  create_table "hgp_cmis_file_revisions", force: :cascade do |t|
    t.integer  "hgp_cmis_file_id",                 limit: 4,                     null: false
    t.integer  "source_hgp_cmis_file_revision_id", limit: 4
    t.string   "name",                             limit: 255,                   null: false
    t.integer  "hgp_cmis_folder_id",               limit: 4
  ...
  create_table "hgp_cmis_files", force: :cascade do |t|
    t.integer  "project_id",         limit: 4,                   null: false
    t.integer  "hgp_cmis_folder_id", limit: 4
    t.string   "name",               limit: 255,                 null: false
    t.boolean  "dirty"
  ...
  create_table "hgp_cmis_folders", force: :cascade do |t|
    t.integer  "project_id",         limit: 4,                     null: false
    t.integer  "hgp_cmis_folder_id", limit: 4
  ...
  create_table "hgp_cmis_project_params", force: :cascade do |t|
    t.integer "project_id", limit: 4
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.boolean  "hgp_cmis_mail_notification"
  end
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.text     "hgp_cmis_description",   limit: 65535
    t.string   "project_name_view",      limit: 255,   default: "0"
    t.integer  "default_version_id",     limit: 4
    t.integer  "default_assigned_to_id", limit: 4
  end

  add_index "projects", ["identifier"], name: "index_projects_on_identifier", using: :btree
  ...
  create_table "protected_branches_members", force: :cascade do |t|
    t.integer "protected_branch_id", limit: 4
    t.integer "principal_id",        limit: 4
    t.integer "inherited_by",        limit: 4
  end

  add_index "protected_branches_members", ["protected_branch_id", "principal_id", "inherited_by"], name: "unique_protected_branch_member", unique: true, using: :btree
  ...
  create_table "redmine_cmis_attachments_project_params", force: :cascade do |t|
    t.integer "project_id", limit: 4
    t.string  "param",      limit: 255
    t.string  "value",      limit: 255
  end
  ...
  add_index "repositories", ["identifier", "project_id"], name: "index_repositories_on_identifier_and_project_id", using: :btree
  add_index "repositories", ["identifier"], name: "index_repositories_on_identifier", using: :btree
  add_index "repositories", ["project_id"], name: "index_repositories_on_project_id", using: :btree

  create_table "repository_deployment_credentials", force: :cascade do |t|
    t.integer "repository_id",          limit: 4
    t.integer "gitolite_public_key_id", limit: 4
    t.integer "user_id",                limit: 4
    t.boolean "active",                             default: true
    t.string  "perm",                   limit: 255,                null: false
  end

  add_index "repository_deployment_credentials", ["repository_id", "gitolite_public_key_id"], name: "index_deployment_credentials_on_repository_id_and_public_key_id", unique: true, using: :btree
  add_index "repository_deployment_credentials", ["repository_id"], name: "index_repository_deployment_credentials_on_repository_id", using: :btree

  create_table "repository_git_config_keys", force: :cascade do |t|
    t.integer "repository_id", limit: 4
  ...
  add_index "repository_git_config_keys", ["key", "type", "repository_id"], name: "unique_key_name", unique: true, using: :btree
  add_index "repository_git_config_keys", ["repository_id"], name: "index_repository_git_config_keys_on_repository_id", using: :btree

  create_table "repository_git_extras", force: :cascade do |t|
    t.integer "repository_id",       limit: 4
    t.boolean "git_daemon",                        default: true
    t.integer "git_http",            limit: 4,     default: 1
    ...
    t.string  "key",                 limit: 255
    t.text    "urls_order",          limit: 65535
    t.string  "notification_sender", limit: 255
    t.string  "notification_prefix", limit: 255
  end

  add_index "repository_git_extras", ["repository_id"], name: "index_repository_git_extras_on_repository_id", unique: true, using: :btree

  create_table "repository_mirrors", force: :cascade do |t|
    t.boolean "active",                           default: true
    t.string  "url",                  limit: 255
    t.integer "push_mode",            limit: 4,   default: 0
    t.boolean "include_all_branches",             default: false
    t.boolean "include_all_tags",                 default: false
    t.string  "explicit_refspec",     limit: 255, default: ""
    t.integer "repository_id",        limit: 4
  end

  add_index "repository_mirrors", ["repository_id"], name: "index_repository_mirrors_on_repository_id", using: :btree
  add_index "repository_mirrors", ["url", "repository_id"], name: "index_repository_mirrors_on_url_and_repository_id", unique: true, using: :btree

  create_table "repository_post_receive_urls", force: :cascade do |t|
    t.boolean "active",                       default: true
    t.string  "url",            limit: 255
    t.string  "mode",           limit: 255,   default: "github"
    t.integer "repository_id",  limit: 4
    t.boolean "use_triggers",                 default: false
    t.text    "triggers",       limit: 65535
    t.boolean "split_payloads",               default: false
  end

  add_index "repository_post_receive_urls", ["repository_id"], name: "index_repository_post_receive_urls_on_repository_id", using: :btree
  add_index "repository_post_receive_urls", ["url", "repository_id"], name: "index_repository_post_receive_urls_on_url_and_repository_id", unique: true, using: :btree

  create_table "repository_protected_branches", force: :cascade do |t|
    t.integer "repository_id", limit: 4
  ...
  add_index "repository_protected_branches", ["repository_id"], name: "index_repository_protected_branches_on_repository_id", using: :btree
  ...
  create_table "user_list_settings", force: :cascade do |t|
    t.integer "user_id", limit: 4,     null: false
    t.string  "list",    limit: 30,    null: false
    t.text    "columns", limit: 65535
  end

  add_index "user_list_settings", ["user_id", "list"], name: "settings_list_user_ids", unique: true, using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "created_by_omniauth_saml",             default: false
  end
