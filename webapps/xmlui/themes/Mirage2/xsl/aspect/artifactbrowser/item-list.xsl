...
<xsl:stylesheet
    ...
    <xsl:variable name="browser" select="not(contains(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='focus'][@qualifier='containerType'][1], 'type:collection'))"/>
        ...
        <div class="artifact-description">
            ...
            <!--xsl:if test="dim:field[@element = 'format' and @qualifier='origin']">
                <div class="artifact-abstract">
                    ...
                    <xsl:if test="dim:field[@element = 'format' and @qualifier='digital'] and dim:field[@element = 'format' and @qualifier='origin']">
                        <xsl:text> - </xsl:text>
                    </xsl:if>
