...
<xsl:stylesheet
	...
	<!-- OCULTA EL APARTADO LISTAR POR EN EL APARTADO LISTAR POR QUE APARECE EN LA PARTE SUPERIOR DE LAS VISTAS DE COMUNIDADES Y COLECCIONES -->
        <!--div>
            <xsl:call-template name="copy-attributes"/>
	...
	<!-- OCULTA LOS BOTONES DEL BROWSER EN EL APARTADO LISTAR POR QUE APARECE EN LA PARTE SUPERIOR DE LAS VISTAS DE COMUNIDADES Y COLECCIONES -->
        <!--xref>
            <xsl:call-template name="copy-attributes"/>
            <xsl:attribute name="rend">
